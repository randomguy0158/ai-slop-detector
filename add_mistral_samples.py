...
# Using Groq with Gemma 2 — different writing style from Llama
client = OpenAI(
...
PROMPTS = [
    ...
    "Write an essay introduction about the impact of social media.",
...
print("\nDone. Now run feature_extractor.py then train_classifier.py")